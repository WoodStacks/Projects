  ...
  return (
    <div className="flex flex-col justify-center">
      ...
      <div className="max-w-[1000px] mx-auto">
        <h2>Sample Front-End Projects & Experiments</h2>

        <p>
          Welcome. This site is a collection of small, focused projects built to
          demonstrate practical front-end development skills. Each project
          emphasizes clean code, modern tooling, and thoughtful user experience.
        ...
        <p>
          ...
          performance-aware implementations. For styling I used Tailwind and Daisy UI.
        </p>
